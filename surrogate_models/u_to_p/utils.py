...
def domain_dist(top_boundary, obst_boundary, xy0):
    """
    Calculate a boolean representing the fluid-flow domain and 
    the signal distance function (sdf).
...
def interp_weights(xyz, uvw, d=2):
    ...
    Args:
        xyz: Coordinates of the original grid.
        uvw: Coordinates of the target grid.
        d: Number of dimensions. Default is 2D.
    """
