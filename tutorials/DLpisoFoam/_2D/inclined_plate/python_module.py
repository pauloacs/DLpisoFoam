...
from pressure_SM._2D.CFD_usable.main import load_pca_and_NN
...
load_pca_and_NN(pca_input_fn, pca_output_fn, maxs_fn, PCA_std_vals_fn, weights_fn, var, model_arch, apply_filter, overlap_ratio, filter_tuple, block_size, grid_res, verbose)

#from surrogate_models.deltau_to_deltap.main import init_func, py_func
from pressure_SM._2D.CFD_usable.main import init_func, py_func
