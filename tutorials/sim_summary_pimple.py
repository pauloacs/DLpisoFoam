...
def parse_logs(log_content):
    ...
    time_block_pattern = re.compile(
        ...
        r'smoothSolver:  Solving for Ux, Initial residual = (?P<ux_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<ux_iterations>\d+)\n'
        r'smoothSolver:  Solving for Uy, Initial residual = (?P<uy_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<uy_iterations>\d+)\n'
        r'smoothSolver:  Solving for Uz, Initial residual = (?P<uz_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<uz_iterations>\d+)\n'
        r'DILUPBiCGStab:  Solving for h, Initial residual = (?P<h_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<h_iterations>\d+)\n'
        r'GAMG:  Solving for p_rgh, Initial residual = (?P<p_iter1_1_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<p_iter1_1_iterations>\d+)\n'
        r'GAMG:  Solving for p_rgh, Initial residual = (?P<p_iter1_2_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<p_iter1_2_iterations>\d+)\n'
        ...
        r'GAMG:  Solving for p_rgh, Initial residual = (?P<p_iter2_1_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<p_iter2_1_iterations>\d+)\n'
        r'GAMG:  Solving for p_rgh, Initial residual = (?P<p_iter2_2_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<p_iter2_2_iterations>\d+)\n'
        r'diagonal:  Solving for rho, Initial residual = .*?, Final residual = .*?, No Iterations (?P<rho3_iterations>\d+)\n'
        r'time step continuity errors : sum local = .*?, global = .*?, cumulative = .*?\n'
        r'smoothSolver:  Solving for omega, Initial residual = (?P<omega_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<omega_iterations>\d+)\n'
        r'smoothSolver:  Solving for k, Initial residual = (?P<k_initial_residual>\d+\.\d+e?-?\d*), Final residual = .*?, No Iterations (?P<k_iterations>\d+)\n'
