...
def process_simulation(i_sim, sim, path_to_sims, avance_list, hdf5_file, first_t, last_t, max_sim, max_patch):
    ...
    hdf5_file['sim_data'][i_sim, ..., 0] = data['Ux']
    hdf5_file['sim_data'][i_sim, ..., 1] = data['Uy']
    hdf5_file['sim_data'][i_sim, ..., 2] = data['Uz']
    hdf5_file['sim_data'][i_sim, ..., 3] = data['p_rgh']
    hdf5_file['sim_data'][i_sim, ..., 4] = data['Cx']
    hdf5_file['sim_data'][i_sim, ..., 5] = data['Cy']
    hdf5_file['sim_data'][i_sim, ..., 6] = data['Cz']
    hdf5_file['sim_data'][i_sim, ..., 7] = data['delta_Ux']
    hdf5_file['sim_data'][i_sim, ..., 8] = data['delta_Uy']
    hdf5_file['sim_data'][i_sim, ..., 9] = data['delta_Uz']
    hdf5_file['sim_data'][i_sim, ..., 10] = data['delta_p_rgh']

    hdf5_file['y_bot_bound'][i_sim, ..., 0] = data_y_bot['Cx']
    hdf5_file['y_bot_bound'][i_sim, ..., 1] = data_y_bot['Cy']
    hdf5_file['y_bot_bound'][i_sim, ..., 2] = data_y_bot['Cz']

    hdf5_file['z_bot_bound'][i_sim, ..., 0] = data_z_bot['Cx']
    hdf5_file['z_bot_bound'][i_sim, ..., 1] = data_z_bot['Cy']
    hdf5_file['z_bot_bound'][i_sim, ..., 2] = data_z_bot['Cz']

    hdf5_file['y_top_bound'][i_sim, ..., 0] = data_y_top['Cx']
    hdf5_file['y_top_bound'][i_sim, ..., 1] = data_y_top['Cy']
    hdf5_file['y_top_bound'][i_sim, ..., 2] = data_y_top['Cz']

    hdf5_file['z_top_bound'][i_sim, ..., 0] = data_z_top['Cx']
    hdf5_file['z_top_bound'][i_sim, ..., 1] = data_z_top['Cy']
    hdf5_file['z_top_bound'][i_sim, ..., 2] = data_z_top['Cz']
    
    hdf5_file['obst_bound'][i_sim, ..., 0] = data_obst['Cx']
    hdf5_file['obst_bound'][i_sim, ..., 1] = data_obst['Cy']
    hdf5_file['obst_bound'][i_sim, ..., 2] = data_obst['Cz']
...
def main():
    ...
    hdf5_path = 'dataset_heat_test_1sim20t.hdf5'
    path_to_sims = 'simulations/'
    max_n_cells_sim = int(1e6)
    ...
    for i_sim, sim in enumerate(tqdm(range(first_sim, last_sim + 1))):
