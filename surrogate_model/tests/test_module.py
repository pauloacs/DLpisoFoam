...
from surrogate_model.main import load_pca_and_NN, init_func, py_func
from surrogate_model.test_data import array, top, obst, ipca_input_fn, ipca_output_fn, maxs_fn, max_PCA_fn, weights_fn
