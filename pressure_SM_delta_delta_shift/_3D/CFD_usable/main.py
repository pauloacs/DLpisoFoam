...
def load_tucker_and_NN(
	...
	global max_abs_delta_delta_Ux, max_abs_delta_delta_Uy, max_abs_delta_delta_Uz, max_abs_dist, max_abs_delta_delta_p
	(max_abs_delta_delta_Ux,
		max_abs_delta_delta_Uy,
	max_abs_delta_delta_Uz,
	max_abs_dist,
	max_abs_delta_delta_p) = maxs
...
def py_func(array_in, U_max_norm, verbose=False):
	...
	grid[:,:,:,0:1] = grid[0,:,:,0:1] / max_abs_delta_delta_Ux
	grid[:,:,:,1:2] = grid[0,:,:,1:2] / max_abs_delta_delta_Uy
	grid[:,:,:,2:3] = grid[0,:,:,2:3] / max_abs_delta_delta_Uz
	...
	res_concat = res_concat * max_abs_delta_delta_p * pow(U_max_norm, 2.0)
