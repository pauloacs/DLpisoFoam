import argparse
from pressure_SM._3D.train_and_eval.main import main_train
from pressure_SM._3D.train_and_eval.SM_call import call_SM_main
...
def train_entry_point():
    ...
    parser.add_argument('--model_architecture', type=str, required=True,
                        help='Model architecture. Options: mlp_small, mlp_big, mlp_huge, mlp_attention, conv1d, '
                             'cnn, senet3d, inception3d, spatial_attention_cnn3d, residual_densenet3d, '
                             'depthwise_separable_cnn3d, dilated_cnn3d, asymmetric_cnn3d, unet3d, unet3d_deep, unet3d_attention, '
                             'mixer, gnn, fno3d')
