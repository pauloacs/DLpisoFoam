...
def define_model_arch(model_architecture: str) -> tuple[int, list]:
    ...
    match model_architecture:
        ...
        case 'inception3d':
            n_layers = None
            width = None
        case 'spatial_attention_cnn3d':
            n_layers = None
            width = None
        case 'residual_densenet3d':
            n_layers = None
            width = None
        case 'depthwise_separable_cnn3d':
            n_layers = None
            width = None
        case 'dilated_cnn3d':
            n_layers = None
            width = None
        case 'asymmetric_cnn3d':
            n_layers = None
            width = None
        case 'cnn_two_heads':
            n_layers = None
        ...
        case 'cnn_shifter_lightweight':
            n_layers = None
            width = None
        case 'simplecnn3d_ddp_shifter':
            n_layers = None
            width = None
        case 'simplecnn3d_ddp_shifter_lightweight':
            n_layers = None
            width = None
        case 'cnn_shifter_velocity':
            n_layers = None
            width = None
        case 'simplecnn3d_ddp_shifter_velocity':
            n_layers = None
            width = None
        case _:
