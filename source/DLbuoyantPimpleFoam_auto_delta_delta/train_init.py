...
if __name__ == "__main__":
    ...
    # Stack: choose dataset channels based on add_U_input, add_ddu_input, and use_previous_dp_input flags
    # Channel combinations vary based on which fields are enabled
    dataset_parts = []
    if add_U_input:
