// Main file for DLpisoFoam_auto_delta_delta
// Based on DLbuoyantPimpleFoam_auto_delta_delta but adapted for pisoFoam (incompressible)
...
int main(int argc, char *argv[])
{
    ...
    while (runTime.loop())
    {
        ...
        // --- Pressure-velocity PISO corrector loop
        {
            ...
            // Store previous time step values (only once per time step)
            p_prev = p;
        ...
        // Calculate pressure deltas AFTER all PISO iterations are complete
