...
: mesh_(mesh),
  ...
  delta_p_(delta_p),
  delta_p_CFD_(delta_p_CFD),
  delta_p_prev_(delta_p_prev),
  p_prev_(p_prev),
  delta_delta_U_(delta_delta_U),
  delta_delta_U_prev_(delta_delta_U_prev),
  delta_delta_p_(delta_delta_p),
  delta_delta_p_prev_(delta_delta_p_prev),
  delta_delta_p_CFD_(delta_delta_p_CFD),
  div_U_(div_U),
  div_dU_(div_dU),
...
void SurrogateModel::init()
{
    ...
    Foam::volVectorField& delta_delta_U         = delta_delta_U_;
    Foam::volVectorField& delta_delta_U_prev    = delta_delta_U_prev_;
    Foam::volScalarField& delta_delta_p         = delta_delta_p_;
    Foam::volScalarField& delta_delta_p_CFD     = delta_delta_p_CFD_;
    Foam::volScalarField& delta_p_prev          = delta_p_prev_;
    Foam::volVectorField& delta_U               = delta_U_;
    Foam::volScalarField& p_prev                = p_prev_;
    Foam::volScalarField& div_U                 = div_U_;
    Foam::volScalarField& div_dU                = div_dU_;
    Foam::volScalarField& div_delta_delta_U     = div_delta_delta_U_;
...
void SurrogateModel::predict()
{
    ...
    Foam::volVectorField& delta_delta_U_prev    = delta_delta_U_prev_;
    Foam::volScalarField& delta_delta_p         = delta_delta_p_;
    Foam::volScalarField& delta_delta_p_prev    = delta_delta_p_prev_;
    Foam::volScalarField& delta_delta_p_CFD     = delta_delta_p_CFD_;
    Foam::volScalarField& delta_p_prev          = delta_p_prev_;
    Foam::volVectorField& delta_U               = delta_U_;
    Foam::volScalarField& p_prev                = p_prev_;
