...
)
{
    ...
    const Foam::scalarField& pvals_prev = delta_p_prev_.internalField();
    const Foam::scalarField& pvals_ddp_prev = delta_delta_p_prev_.internalField();
...
void DataSampler::writeSample()
{
    ...
    writeFieldData(delta_delta_U_, delta_delta_p_CFD_, timeStep_, U_MAX_NORM);
