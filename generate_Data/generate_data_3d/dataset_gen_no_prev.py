...
def main():
    ...
    last_sim = 8
    total_times = 20
    hdf5_path = 'dataset_plate_piso_28May_20t_9sim.hdf5'
    ...
    hdf5_file = create_hdf5_file(hdf5_path, int(last_sim-first_sim), total_times, max_n_cells_sim, max_n_cells_patch)
